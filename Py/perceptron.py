# -*- coding: utf-8 -*-
"""
Created on Wed Jul 21 12:36:11 2021

@author: ThisPC
"""
"""
perceptron:- A Perceptron is an algorithm used for supervised learning of binary classifiers.
...
Working:- The process begins by taking all the input values and multiplying them by their weights.
...
The activation function plays the integral role of ensuring the output is mapped between required values such as (0,1) or (-1,1).
