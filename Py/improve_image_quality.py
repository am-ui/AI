# -*- coding: utf-8 -*-
"""
Created on Sat Jul 17 11:57:16 2021
...
hence we need to improve the resolution of the images
whenever we zoom out the images 
then it will be not explored and quality will maintained
...
modelScale = (modelScale[:modelScale.find(".")])
